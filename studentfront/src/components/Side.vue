			...
			<ul class="metismenu" id="menu">
				...
				<li>
					<a class="has-arrow" href="javascript:;">
						<div class="parent-icon icon-color-10"><i class="bx bx-group"></i>
						</div>
						<div class="menu-title">Staff</div>
					</a>
					<ul>
						
						<li><router-link to="createPosition">Create Position</router-link> </li>
						<li><router-link to="createStaff">Create Staff</router-link> </li>
						<li><router-link to="createStaffCategory">create Staff Category</router-link> </li>
						<li><router-link to="listCategory">List Category</router-link> </li>
						<li><router-link to="listPosition">List Position</router-link> </li>
						<li><router-link to="listStaff">List Staff</router-link> </li>
					</ul>
				</li>
				<li>
					<a class="has-arrow" href="javascript:;">
						<div class="parent-icon icon-color-11"><i class="fa fa-users"></i>
						</div>
						<div class="menu-title">Student</div>
					</a>
					<ul>
						<li><router-link to="createStudent">Create Student</router-link> </li>
						<li><router-link to="listStudent">List Student</router-link> </li>
					</ul>
				</li>
				<li>
					<a class="has-arrow" href="javascript:;">
